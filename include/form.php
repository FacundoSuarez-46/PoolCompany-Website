...
$toemails[] = array(
				'email' => 'contacto@gympiscinas.com', // Your Email Address
				'name' => 'G&M' // Your Name
			);
...
$fromemail = array(
				'email' => 'contacto@gympiscinas.com', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'G&M' // Company Name
			);
...
$message = array(
	'success'			=> 'Hemos recibido <strong>Exitosamente</strong> su mensaje.',
	'error'				=> 'su consulta <strong>No pudo</strong> ser enviada intente denuevo mas tarde.',
	'error_bot'			=> 'Bot detectado',
	'error_unexpected'	=> 'Un <strong>error se detecto</strong> Prueba mas tarde.',
	'recaptcha_invalid'	=> 'Captcha no validado prueba denuevo',
	'recaptcha_error'	=> 'Captcha no enviado prueba denuevo.'
);
